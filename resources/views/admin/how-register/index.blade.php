                ...
                data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
						...
						@foreach($rows as $index => $row)
							<tr>
                                ...
                                <td>{{$row->title_ar}}</td>
                                <td>{{$row->title_en}}</td>
                                {{-- <td><img src="{{ asset('uploads/why_us') }}/{{ $row->image }}" width="100" height="100"> </td> --}}


                                      <td>
                                        <div class="btn-group">

                                            <a href="{{ route('how-register.edit', $row->id) }}">
                             ...
                             <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <form action="{{ route('how-register.destroy', $row->id) }}"  method="POST" >
                                    @csrf
                                    @method('DELETE')
