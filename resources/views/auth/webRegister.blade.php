            ...
            <div class="col-lg-6 col-md-12">
                ...
                <form class="pt-5" method="post" action=" {{ LaravelLocalization::localizeUrl('/captcha-validation') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-control select-multiple"  multiple name="schools[]"  aria-label="Default select example" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="total_cost" min="1" value="{{old('total_cost')}}" name="total_cost" class="form-control @error('total_cost') is-invalid @enderror">
                        @error('total_cost')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
